...
<?php
	...
	include 'include/conexao.php';	// incluindo arquivo de conexão
	include 'include/navbar.php'; // incluindo arquivo barra de navegação
	include 'include/cabecalho.html'; // incluindo cabeçalho
